  ...
  const newsPosts = await Promise.all([
    prisma.newsPost.upsert({
      ...
      create: {
        ...
        excerpt: 'We are pleased to announce that registration for NJNC 2028 is now open. Early bird rates available.',
    ...
    prisma.newsPost.upsert({
      ...
      create: {
        ...
        excerpt: 'Submit your abstracts for NJNC 2028. The deadline has been extended to give more researchers the opportunity to participate.',
    ...
    prisma.newsPost.upsert({
      ...
      create: {
        ...
        excerpt: 'We are thrilled to announce our distinguished keynote speakers from Japan, India, USA, and Nepal.',
  ...
  const contentBlocks = await Promise.all([
    ...
    prisma.contentBlock.upsert({
      ...
      create: {
        ...
        data: {
          content: 'NJNC is an international medical conference organized by the Nepal Epilepsy Society in collaboration with ILAE, bringing together neurologists, researchers, and specialists from across the world.',
        },
      },
    }),
  ]);
