  ...
  if (success) {
    return (
      <div className="rounded-2xl bg-white/95 backdrop-blur-sm p-8 shadow-2xl text-center">
        ...
        <h1 className="font-display text-display-5 text-navy mb-2">Password Reset</h1>
        <p className="text-slate text-sm mb-6">Your password has been reset successfully.</p>
        <Link href="/login" className="bg-primary text-white px-6 py-2.5 rounded-lg text-sm font-semibold hover:bg-primary/90 transition-colors inline-block">
          Sign In
        </Link>
      </div>
    );
  ...
  return (
    <div className="rounded-2xl bg-white/95 backdrop-blur-sm p-8 shadow-2xl">
      <div className="text-center mb-6">
        <h1 className="font-display text-display-4 text-navy mb-2">New Password</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          <label htmlFor="confirm" className="block text-sm font-medium text-navy mb-1.5">Confirm Password</label>
