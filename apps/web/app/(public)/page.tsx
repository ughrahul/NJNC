...
const nepalImages = [
  { src: 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?w=800', alt: 'Mount Everest at sunrise', title: 'Himalayas' },
  { src: 'https://images.unsplash.com/photo-1605640840605-14ac1855827b?w=800', alt: 'Boudhanath Stupa', title: 'Heritage' },
  { src: 'https://images.unsplash.com/photo-1571401835393-8c5f35328320?w=800', alt: 'Phewa Lake Pokhara', title: 'Nature' },
];

const categories = [
  { name: 'International', price: '$300', features: ['Full conference access', 'CME certificate', 'Conference materials', 'Welcome dinner'] },
  { name: 'SAARC', price: '$150', features: ['Full conference access', 'CME certificate', 'Conference materials', 'Welcome dinner'] },
  { name: 'National', price: 'NPR (See QR)', features: ['Full conference access', 'CME certificate', 'Conference materials', 'Welcome dinner'] },
  { name: 'Resident / MO / Paramedics', price: '$75', features: ['Full conference access', 'CME certificate', 'Conference materials'] },
];
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 max-w-5xl mx-auto pt-20">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-1.5 mb-6 border border-white/10">
            ...
            <span className="text-xs font-medium text-white/80 uppercase tracking-widest">Registration Open</span>
          </div>
      ...
      <section className="py-24 bg-snow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <span className="text-sm font-semibold text-gold uppercase tracking-widest">Beyond the Conference</span>
            <h2 className="font-display text-display-2 text-navy mt-3 mb-4">Discover Nepal</h2>
            <p className="text-slate max-w-2xl mx-auto">
              Experience the breathtaking landscapes, ancient temples, and warm hospitality that make Nepal truly extraordinary.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {nepalImages.map((img) => (
              <Link key={img.title} href="/discover-nepal" className="group relative rounded-2xl overflow-hidden aspect-[4/5] shadow-lg">
                <img
                  src={img.src}
                  alt={img.alt}
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <h3 className="font-display text-xl font-bold text-white mb-1">{img.title}</h3>
                  <span className="text-sm text-white/70 group-hover:text-gold transition-colors">Explore →</span>
                </div>
              </Link>
            ))}
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <span className="text-sm font-semibold text-gold uppercase tracking-widest">Registration</span>
            <h2 className="font-display text-display-2 text-navy mt-3 mb-4">Delegate Categories</h2>
            <p className="text-slate max-w-2xl mx-auto">
              Choose the category that best fits your profile. All categories include full conference access.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {categories.map((cat, i) => (
              ...
              >
                ...
                <h3 className="font-display text-lg font-bold text-navy mb-2">{cat.name}</h3>
                <div className="font-display text-3xl font-bold text-primary mb-4">{cat.price}</div>
      ...
      <section className="py-24 bg-gradient-to-br from-primary-900 via-navy to-primary-950 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="text-sm font-semibold text-gold uppercase tracking-widest">Call for Abstracts</span>
          <h2 className="font-display text-display-2 mt-3 mb-4">Share Your Research</h2>
          <p className="text-white/70 max-w-2xl mx-auto mb-8">
            Submit your abstract for oral or poster presentation. Accepted abstracts will be published in the conference proceedings.
          </p>

          <div className="flex flex-wrap justify-center gap-3 mb-10">
            {faqTopics.map((topic) => (
              <span key={topic} className="px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-sm text-white/80 border border-white/10">
                {topic}
              </span>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="font-display text-display-2 text-navy mt-3 mb-4">{CONFERENCE.venue.name}</h2>
              <p className="text-slate leading-relaxed mb-6">
                Located in the heart of Kathmandu's diplomatic district of Lazimpat, Hotel Radisson Blu offers
                world-class conference facilities with stunning views of the Himalayan range. The hotel features
                state-of-the-art meeting halls, premium accommodation, and easy access to Kathmandu's cultural landmarks.
              </p>
              <div className="space-y-3 mb-8">
                ...
                <div className="flex items-center gap-3 text-sm text-slate">
                  <span className="text-lg">✈️</span> 6 km from Tribhuvan International Airport
                </div>
              </div>
              <Link
                href="/venue"
      ...
      <section className="py-20 bg-gradient-to-r from-crimson via-crimson-600 to-crimson-700 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">
            Join leading neurologists from around the world at NJNC 2028. Don't miss this unique opportunity.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/register" className="bg-white text-crimson px-8 py-4 rounded-xl text-lg font-bold hover:bg-white/90 transition-colors shadow-lg">
              Register Now
            </Link>
            <Link href="/discover-nepal" className="border-2 border-white/40 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-white/10 transition-colors">
              Discover Nepal
            </Link>
          </div>
        </div>
