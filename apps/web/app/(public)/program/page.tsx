...
const day1Sessions: Session[] = [
  ...
  },
  {
    ...
    type: "WORKSHOP",
    duration: "90 min",
    speaker: "Dr. Rajesh Khadka",
  },
  {
    id: "5",
    time: "10:15",
    title: "Neurogenetics: From Bench to Bedside",
    hall: "Hall A",
    type: "KEYNOTE",
    duration: "45 min",
  ...
  },
  {
    ...
    type: "PANEL",
    duration: "60 min",
    speaker: "Dr. Anjali Sharma et al.",
  },
  {
    id: "7",
    time: "11:00",
  ...
  },
  {
    id: "8",
    time: "11:30",
    title: "Oral Presentations — Session 1",
    hall: "Hall A",
  ...
  },
  {
    id: "9",
    time: "11:30",
    title: "Movement Disorders Masterclass",
    hall: "Hall B",
    type: "WORKSHOP",
    duration: "90 min",
    speaker: "Prof. Kenji Suzuki",
  },
  {
    id: "10",
    time: "13:00",
  ...
  },
  {
    id: "11",
    time: "14:00",
    title: "Stroke Management in South Asia",
    hall: "Hall A",
    type: "PANEL",
    duration: "60 min",
    speaker: "Dr. Priya Adhikari et al.",
  },
  {
    id: "12",
    time: "14:00",
...
const day2Sessions: Session[] = [
  ...
  },
  {
    id: "16",
    time: "09:00",
    title: "Neurocritical Care — Current Practices",
    hall: "Hall A",
    type: "KEYNOTE",
    duration: "45 min",
    speaker: "Dr. Maya Shrestha",
  },
  {
    id: "17",
    time: "09:00",
    title: "EEG Interpretation Workshop",
    hall: "Workshop Room",
    type: "WORKSHOP",
    duration: "90 min",
  },
  {
    id: "18",
    time: "10:00",
    title: "Oral Presentations — Session 2",
    hall: "Hall A",
    type: "ORAL_PRESENTATION",
    duration: "90 min",
  },
  ...
  },
  {
    id: "21",
    time: "12:00",
    title: "Nepal-Japan Joint Research Session",
    hall: "Hall A",
    type: "PANEL",
    duration: "60 min",
  },
  {
    id: "22",
    time: "13:00",
    title: "Lunch & Poster Session 2",
    hall: "Dining / Exhibition",
    type: "BREAK",
    duration: "90 min",
  },
  {
      ...
      <section className="py-20 bg-gradient-to-br from-primary-900 to-navy text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-white/70 text-lg max-w-2xl mx-auto">
            Two days of world-class sessions across three halls — September
            18–19, 2028.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap gap-3 mb-8 justify-center">
            {(Object.keys(typeColors) as SessionType[]).map((type) => (
              <span
                key={type}
                className={`text-xs px-3 py-1 rounded-full border ${typeColors[type]}`}
              >
                {type.replace("_", " ")}
              </span>
            ))}
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span
                      className={`text-xs px-2 py-0.5 rounded-full border ${typeColors[session.type]}`}
                    >
                      {session.type.replace("_", " ")}
                    </span>
                  </div>
                  {session.speaker && (
                    <p className="text-xs text-slate">{session.speaker}</p>
                  )}
                </div>
