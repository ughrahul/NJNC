...
export const metadata: Metadata = {
  title: 'Committee',
  description: 'Meet the organizing, scientific, and advisory committees of NJNC 2028.',
};

const organizing = [
  { name: 'Prof. Upendra Devkota', role: 'Conference President', institution: 'Annapurna Neurological Institute' },
  { name: 'Ms. Medhawee Nepal', role: 'Conference Secretary', institution: 'NES Secretariat' },
  { name: 'Dr. Basant Pant', role: 'Finance Coordinator', institution: 'Annapurna Neurological Institute' },
  { name: 'Dr. Reema Rajbhandari', role: 'Scientific Chair', institution: 'TU Teaching Hospital' },
];
    ...
    <div className="pt-24">
      ...
      <section className="py-20 bg-gradient-to-br from-primary-900 to-navy text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
          <span className="text-sm font-semibold text-gold uppercase tracking-widest">Our Team</span>
          <h1 className="font-display text-display-1 mt-3 mb-4">Committee</h1>
          <p className="text-white/70 text-lg max-w-2xl mx-auto">
            The dedicated team behind NJNC 2028 — organizing a world-class neurology event.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-snow">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <h2 className="font-display text-display-3 text-navy mb-8 text-center">Organizing Committee</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {organizing.map((member) => (
              <div key={member.name} className="bg-white rounded-2xl p-6 border text-center hover:shadow-lg transition-shadow">
                ...
                <h3 className="font-display font-bold text-navy text-sm">{member.name}</h3>
                <p className="text-xs text-gold font-semibold mt-1">{member.role}</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <h2 className="font-display text-display-3 text-navy mb-8 text-center">Scientific Committee</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {scientific.map((member) => (
              <div key={member.name} className="flex items-center gap-4 bg-snow rounded-xl p-4 border">
      ...
      <section className="py-20 bg-snow">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <h2 className="font-display text-display-3 text-navy mb-8 text-center">Advisory Board</h2>
      ...
      <section className="py-16 bg-primary text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          <h2 className="font-display text-display-3 mb-3">Conference Secretary</h2>
          <p className="text-xl font-semibold mb-1">{CONFERENCE.secretary.name}</p>
          <p className="text-white/70 mb-6">For any queries, reach out directly:</p>
