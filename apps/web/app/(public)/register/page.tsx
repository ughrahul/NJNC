          ...
          {steps.map((s, i) => (
            <div key={s} className="flex items-center flex-1">
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs text-slate mt-1 hidden sm:block">
                  {s}
                </span>
              </div>
              {i < steps.length - 1 && (
        ...
        <div className="bg-white rounded-2xl shadow-lg border p-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-lg border text-sm focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none"
                  placeholder="Tokyo Medical University"
                />
              </div>
            </div>
          )}
          ...
          {step === 1 && (
            <div className="space-y-6">
              ...
              <label className="flex items-center gap-3 text-sm text-navy">
                <input
                  type="checkbox"
                  checked={form.cmeCertificate}
                  onChange={(e) => update("cmeCertificate", e.target.checked)}
            ...
            <div className="space-y-6">
              ...
              {form.category === "NATIONAL" ? (
                ...
                <div className="bg-primary-50 rounded-xl p-6 border border-primary-200">
                  ...
                  <div className="space-y-2 text-sm">
                    <p>
                      <strong className="text-navy">Account Holder:</strong>{" "}
                      <span className="text-slate">
                        {CONFERENCE.bankDetails.accountHolder}
                      </span>
                    </p>
                    <p>
                      <strong className="text-navy">Account Number:</strong>{" "}
                      <span className="text-slate font-mono">
                        {CONFERENCE.bankDetails.accountNumber}
                      </span>
                    </p>
                    <p>
                      <strong className="text-navy">SWIFT Code:</strong>{" "}
                      <span className="text-slate font-mono">
                        {CONFERENCE.bankDetails.swiftCode}
                      </span>
                    </p>
                    <p>
                      <strong className="text-navy">Bank:</strong>{" "}
                      <span className="text-slate">
                        {CONFERENCE.bankDetails.bankName}
                      </span>
                    </p>
                    <p>
                      <strong className="text-navy">Location:</strong>{" "}
                      <span className="text-slate">
                        {CONFERENCE.bankDetails.location}
                      </span>
                    </p>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-primary transition-colors cursor-pointer">
                  ...
                  <p className="text-sm text-slate">
                    Click to upload your payment receipt or screenshot
                  </p>
          ...
          {step === 3 && (
            <div className="text-center py-8">
              ...
              <h2 className="font-display text-display-3 text-navy mb-3">
                Registration Submitted!
              </h2>
              <p className="text-slate max-w-md mx-auto mb-6">
                Thank you for registering for NJNC 2028. Your registration is
                pending payment verification. You will receive a confirmation
                email shortly.
              </p>
              <div className="bg-snow rounded-xl p-6 border inline-block text-left">
                ...
                <p className="text-sm">
                  <strong className="text-navy">Status:</strong>{" "}
          ...
          <div className="flex justify-between mt-8 pt-6 border-t">
            {step > 0 && step < 3 ? (
              <button
                ...
                className="px-6 py-2.5 rounded-lg border text-sm font-medium text-slate hover:bg-gray-50 transition-colors"
              >
                ← Back
              </button>
            ) : (
            ...
            {step < 3 && (
              <button
                onClick={() => setStep(step + 1)}
                className="px-6 py-2.5 rounded-lg bg-primary text-white text-sm font-semibold hover:bg-primary-700 transition-colors"
              >
