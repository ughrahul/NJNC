...
const recentActivity = [
  {
    text: "Dr. Tanaka registered (International)",
    time: "5 min ago",
    icon: "📝",
  },
  ...
  {
    text: "Speaker confirmed: Prof. Yamamoto",
    time: "2 hours ago",
    icon: "🎤",
  },
        ...
        {kpis.map((kpi) => (
          ...
          >
            <div className="flex items-center justify-between mb-3">
              <span
                className={`w-10 h-10 rounded-lg ${kpi.color} flex items-center justify-center text-lg`}
              >
                {kpi.icon}
              </span>
            </div>
