          ...
          <div className="absolute right-0 top-0 bottom-0 w-72 bg-white shadow-2xl animate-in slide-in-from-right">
            <div className="p-6 border-b">
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => setMobileOpen(false)} className="p-1 text-slate hover:text-navy">
            ...
            <div className="p-4 space-y-2 border-t">
              <Link href="/register" className="block w-full text-center bg-gold text-white px-4 py-3 rounded-lg text-sm font-semibold">
                Register Now
              </Link>
              <Link href="/login" className="block w-full text-center text-primary px-4 py-3 rounded-lg text-sm font-medium border border-primary/20">
                Sign In
              </Link>
            </div>
          </div>
