        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <a href={`https://wa.me/${CONFERENCE.secretary.whatsapp}`} className="w-9 h-9 rounded-full bg-white/10 hover:bg-forest/30 flex items-center justify-center transition-colors" aria-label="WhatsApp">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-display text-sm font-bold uppercase tracking-wider text-white/40 mb-4">Quick Links</h4>
          ...
          {/* Resources */}
          <div>
            <h4 className="font-display text-sm font-bold uppercase tracking-wider text-white/40 mb-4">Resources</h4>
            <ul className="space-y-2.5">
              {resources.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-white/60 hover:text-gold transition-colors">
          ...
          {/* Contact & Newsletter */}
          <div>
            <h4 className="font-display text-sm font-bold uppercase tracking-wider text-white/40 mb-4">Stay Updated</h4>
            <p className="text-sm text-white/60 mb-3">Get the latest conference updates.</p>
            <form className="flex gap-2 mb-6" onSubmit={(e) => e.preventDefault()}>
              ...
              />
              <button type="submit" className="px-3 py-2 bg-gold hover:bg-gold-700 text-white rounded-lg text-sm font-medium transition-colors">
                →
              </button>
            </form>
